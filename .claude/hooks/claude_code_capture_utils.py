...
Provides common functionality for path detection, metadata injection, and log routing.
"""
import json
import os
...
def add_ab_metadata_to_log_entry(log_entry, cwd):
    """Add A/B testing metadata to a log entry."""
