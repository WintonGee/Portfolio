#!/usr/bin/env python3
"""
Copy raw transcript to logs folder for complete data preservation.
...
def copy_raw_transcript():
    ...
    try:
        ...
        if source_path.exists():
            ...
            print(f"✓ Copied raw transcript to {dest_path}")
        else:
            print(f"⚠ Raw transcript not found at {source_path}", file=sys.stderr)
